...
extension String {
    ...
    // the following is all taken from https://stackoverflow.com/questions/25607247/how-do-i-decode-html-entities-in-swift
    // This is Martin R's answer, about 3 answers down. (https://stackoverflow.com/users/1187415/martin-r)
    // it uses only pure swift, not depending on WebKit or any platform-specific library
